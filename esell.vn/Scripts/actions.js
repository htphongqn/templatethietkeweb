...
function addiCodes(catid, title, desc, url, code, s5,s6,s7,status,img,starts,merchant){
	...
	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=icodes&type='+s7+'&catid='+catid+'&title='+title+'&desc='+desc+'&url='+url+'&code='+code+'&exp='+s5+'&mer='+s6+'&st='+status+'&img='+img+'&starts='+starts+'&merchant='+merchant,'ShopperPressAlert');
}
...
function addAmazonProduct(catid, country, asnid){
	...
	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=addAmazonProduct&country='+country+'&catid='+catid+'&asnid='+asnid,'ShopperPressAlert');
}
function addEbayProduct(catid, country, ID, api, aff1, aff2){

	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=addEbayProduct&country='+country+'&catid='+catid+'&ID='+ID+'&API='+api+'&aff1='+aff1+'&aff2='+aff2,'ShopperPressAlert');
}
function UpdateWishlist(itemID,action){

	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=WishList&itemID='+itemID+'&act='+action,'WishlistAlert');
}
function JobWatchList(itemID,action){

	PremiumPressDo('wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=JobWatchList&itemID='+itemID+'&act='+action,'WishlistAlert');
}

function addMovie(catid, ID, NETWORK){

	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=addMovie&catid='+catid+'&ID='+ID+'&network='+NETWORK,'ShopperPressAlert');
}
