...
(function ($) {
    $.fn.simplyScroll = function (o) { return this.each(function () { new $.simplyScroll(this, o); }); }; var defaults = { className: 'simply-scroll', frameRate: 24, speed: 1, horizontal: true, autoMode: 'off', pauseOnHover: true, startOnLoad: true, localJsonSource: '', flickrFeed: '', jsonImgWidth: 240, jsonImgHeight: 180 }; $.simplyScroll = function (el, o) {
        ...
        this.interval = null; this.intervalDelay = Math.floor(1000 / this.o.frameRate); while (this.itemMax % this.o.speed !== 0) { this.o.speed--; if (this.o.speed === 0) { this.o.speed = 5; break; } }
