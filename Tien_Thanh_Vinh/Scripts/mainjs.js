...
{
	jlast3t('div.cycle_3t').css('visibility','visible').css('opacity',0);
	jlast3t('div.cycle_3t img:first').css('opacity',1);
	jlast3t('div.cycle_3t img:last').css('opacity',1);
	jlast3t('div.cycle_3t').delay(500);
	jlast3t('div#cycle_1').animate({'top':'40px','left':'235px','opacity':1},1000,'swing',function(){
