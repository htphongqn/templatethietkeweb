	...
	$.Gallery.prototype 	= {
		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translate(-215px) scale(0.8)',
					'-moz-transform'	: 'translate(-215px) scale(0.8)',
					'-o-transform'		: 'translate(-215px) scale(0.8)',
					'-ms-transform'		: 'translate(-215px) scale(0.8)',
					'transform'			: 'translate(-215px) scale(0.8)'
				};
